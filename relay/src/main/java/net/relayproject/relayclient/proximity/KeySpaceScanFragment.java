 ...
 */
public class KeySpaceScanFragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layoutView = inflater.inflate(R.layout.fragment_keyspace_scan, container, false);
//        TextView txt = (TextView) layoutView.findViewById(R.id.fragment_keyspace_scan_text);
